...
#if defined(NDEBUG)
# error "Genex cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Genex Signed Message:\n";
                              ...
                              bool bypass_limits, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s GENEX additional fees, %d delta bytes\n",
