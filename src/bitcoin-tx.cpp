...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s genex-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  genex-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded genex transaction") + "\n" +
              "  genex-tx [options] -create [commands]   " + _("Create hex-encoded genex transaction") + "\n" +
              "\n";
